...
class TestCompletionCount:
    ...
    def test_filtered_by_start_date(self):
        ...
        def test_for_weekly_habit():
            ...
            num_times_completed = week_habit.get_number_of_times_completed(
                utils.to_datetime("2023-06-17 00:00:01")
            )
            assert num_times_completed == 2
    ...
    def test_filtered_by_end_date(self):
        def test_for_daily_habit():
            ...
            num_times_completed = day_habit.get_number_of_times_completed(
                end_date=utils.to_datetime("2023-06-11 18:32:51")
            )
            assert num_times_completed == 3
        ...
        def test_for_weekly_habit():
            ...
            num_times_completed = week_habit.get_number_of_times_completed(
                end_date=utils.to_datetime("2023-05-31 01:32:51")
            )
            assert num_times_completed == 1
    ...
    def test_filter_returns_no_activities(self):
        def test_for_daily_habit():
            ...
            num_times_completed = day_habit.get_number_of_times_completed(
                end_date=utils.to_datetime("2023-05-28 23:45:12")
            )
            assert num_times_completed == 0
        ...
        def test_for_weekly_habit():
            ...
            num_times_completed = week_habit.get_number_of_times_completed(
                utils.to_datetime("2023-06-28 10:45:12"),
                utils.to_datetime("2023-06-30 01:32:51")
            )
            assert num_times_completed == 0
...
class TestCompletionRate:
    ...
    def test_with_start_date_only(self):
        def test_for_daily_habit():
            ...
            assert completion_stats["num_active_periods"] == 3
            assert completion_stats["num_total_periods"] == 31
            perc = round(100 * completion_stats["rate"])
            assert perc == 10
        ...
        def test_for_weekly_habit():
            ...
            assert completion_stats["num_active_periods"] == 3
            assert completion_stats["num_total_periods"] == 4
            perc = round(100 * completion_stats["rate"])
            assert perc == 75
    ...
    def test_with_no_date_restriction(self):
        def test_for_daily_habit():
            ...
            assert completion_stats["num_total_periods"] == 37
            perc = round(100 * completion_stats["rate"])
            assert perc == 14

        def test_for_weekly_habit():
            week_habit = Habit("Phone parents", "weekly", "2023-05-29 19:04:55")
            week_habit.perform("2023-05-29 21:12:32")
            week_habit.perform("2023-05-31 14:54:22")
            week_habit.perform("2023-06-11 06:55:10")
            week_habit.perform("2023-06-17 18:25:43")
            week_habit.perform("2023-06-25 20:46:06")
